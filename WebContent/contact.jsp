<%@ page import="org.ecore.model.Need"%>
...
<%
	...
	if (request.getParameter("submit") != null) {
		...
		need.createEmailMessage(emailSubject, emailBody);
		try {
			need.sendEmail();
			status = "success";
...
<body>
	<div id="central">
		<div class="content">
			<h1>Need Response Form</h1>
			<p>Send your response through this form and we will get back to
				you.</p>
			<div id="message">
